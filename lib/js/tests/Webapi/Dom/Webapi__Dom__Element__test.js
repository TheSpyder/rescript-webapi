...
Webapi__Dom__Element$Webapi.insertAdjacentElement(el, /* BeforeBegin */0, el2);

Webapi__Dom__Element$Webapi.insertAdjacentHTML(el, /* AfterBegin */1, "<strong>text</strong>");

Webapi__Dom__Element$Webapi.insertAdjacentText(el, /* AfterEnd */3, "text");
