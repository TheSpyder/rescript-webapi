...
var htmlElm = TestHelpers$Webapi.unsafelyUnwrapOption(Webapi__Dom__HtmlElement$Webapi.ofElement(document.createElement("strong")));
...
var htmlDoc = TestHelpers$Webapi.unsafelyUnwrapOption(Webapi__Dom__Document$Webapi.asHtmlDocument(document));
