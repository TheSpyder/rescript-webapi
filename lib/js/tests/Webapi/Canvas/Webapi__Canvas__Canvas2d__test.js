...
var Webapi__Canvas__CanvasImageSource = require("../../../src/Webapi/Canvas/Webapi__Canvas__CanvasImageSource.js");
...
ctx.drawImage(Webapi__Canvas__CanvasImageSource.ofImage(image), 0.0, 0.0);

ctx.drawImage(Webapi__Canvas__CanvasImageSource.ofImage(image), 0.0, 0.0, 16.0, 16.0);

ctx.drawImage(Webapi__Canvas__CanvasImageSource.ofImage(image), 0.0, 0.0, 16.0, 16.0, 0.0, 0.0, 16.0, 16.0);
