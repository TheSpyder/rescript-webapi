...
[@send] external bufferFloatData : (glT, int, Js.Typed_array.Float32Array.t, int) => unit = "bufferData";
...
[@send] external vertexAttribPointer : (glT, int, int, int, bool, int, int) => unit = "vertexAttribPointer";
