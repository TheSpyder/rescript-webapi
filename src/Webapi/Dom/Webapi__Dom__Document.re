module Impl = (T: {type t;}) => {
  ...
  [@send]  external createElementWithOptions: (T.t, string, Js.t({..})) => Dom.element = "createElement"; /* not widely supported */
  [@send]  external createElementNS: (T.t, string, string) => Dom.element = "";
  [@send]  external createElementNSWithOptions: (T.t, string, string, Js.t({..})) => Dom.element = "createElementNS"; /* not widely supported */
  ...
  [@send]  external createNodeIteratorWithWhatToShow: (T.t, Dom.node_like('a), Webapi__Dom__Types.WhatToShow.t) => Dom.nodeIterator = "createNodeIterator";
  [@send]  external createNodeIteratorWithWhatToShowFilter: (T.t, Dom.node_like('a), Webapi__Dom__Types.WhatToShow.t, Dom.nodeFilter) => Dom.nodeIterator = "createNodeIterator"; /* createProcessingInstruction */
  ...
  [@send]  external createTreeWalkerWithWhatToShow: (T.t, Dom.element_like('a), Webapi__Dom__Types.WhatToShow.t) => Dom.treeWalker = "createTreeWalker";
  [@send]  external createTreeWalkerWithWhatToShowFilter: (T.t, Dom.element_like('a), Webapi__Dom__Types.WhatToShow.t, Dom.nodeFilter) => Dom.treeWalker = "createTreeWalker";
  ...
  [@send]  external importNodeDeep: (T.t, Dom.element_like('a), [@as {json|true|json}] _) => Dom.element_like('a) = "importNode";
  [@send]  external registerElement: (T.t, string, unit) => Dom.element = ""; /* experimental and deprecated in favor of customElements.define() */
  [@send]  external registerElementWithOptions: (T.t, string, Js.t({..}), unit) => Dom.element = "registerElement"; /* experimental and deprecated in favor of customElements.define() */
