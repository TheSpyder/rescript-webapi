...
module Impl = (T: {type t;}) => {
  ...
  [@send]  external getComputedStyleWithPseudoElement: (t_window, Dom.element, string) => Dom.cssStyleDeclaration = "getComputedStyle";
  ...
  [@send] [@return nullable] external open_: t_window => (~url: string, ~name: string, ~features: string=?) => option(Dom.window) = "open"; /* yes, features is a stringly typed list of key value pairs, sigh */
  [@send]  external postMessage: (t_window, 'a, string) => unit = ""; /* experimental-ish?, Web Messaging */
  [@send]  external postMessageWithTransfers: (t_window, 'a, string, array(transferable)) => unit = "postMessage"; /* experimental-ish?, Web Messaging */
  ...
  [@send]  external requestIdleCallbackWithOptions: (t_window, idleDeadline => unit, {. "timeout": int}) => idleCallbackId = "requestIdleCallback"; /* experimental, Cooperative Scheduling of Background Tasks */
  ...
  [@send]  external addPopStateEventListener: (t_window, [@as "popstate"] _, Dom.popStateEvent => unit) => unit = "addEventListener";
  [@send]  external removePopStateEventListener: (t_window, [@as "popstate"] _, Dom.popStateEvent => unit) => unit= "removeEventListener";
