...
let event: AnimationEvent.t = make("my-event")
...
/* AnimationEvent */
let animationName: string = animationName(event)
let elapsedTime: float = elapsedTime(event)
let pseudoElement: string = pseudoElement(event)
